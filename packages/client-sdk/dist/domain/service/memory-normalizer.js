...
export class MemoryNormalizer {
    ...
    dummyArgon2id;
    preAllocated = null;
    constructor(allocator, randomFill, dummyArgon2id) {
        this.allocator = allocator;
        this.randomFill = randomFill;
        this.dummyArgon2id = dummyArgon2id;
    }
    /**
     ...
     */
    async normalizeAccessPattern(argon2idAlreadyRan) {
        if (argon2idAlreadyRan)
            return; // Tier 0: real Argon2id already produced the pattern
